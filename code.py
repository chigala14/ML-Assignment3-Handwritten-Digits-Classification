...
def preprocess():
    ...
    mat = loadmat('D:\Chirag\Savefiles\Downloads\ML\A3\mnist_all.mat') #loads the MAT object as a Dictionary
...
param_pickle=open('D:\Chirag\Savefiles\Downloads\ML\A3\param.pickle','wb')
